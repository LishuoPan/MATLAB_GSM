function [] = plot_save_compare(xtrain,ytrain,xtest,ytest,nTest,pMean_DCP,pVar_DCP,pMean_ADMM,figName,file_name)
figure(); hold on;
...
p2 = plot(xtest(1:nTest), pMean_DCP(1:nTest),'k-','LineWidth',1.5);

p3 = plot(xtest(1:nTest), pMean_ADMM(1:nTest),'r-','LineWidth',1.5);
