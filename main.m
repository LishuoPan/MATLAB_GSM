...
if Opt_method == 1
    ...
    % ADMM ML Opt
    options_ADMM = struct('rho', 100, 'rho_dual', 10, 'inner_loop', 300, 'mu', 1e-6, 'MAX_iter', 2000, 'nv', varEst, ...
...
%     plot_save(xtrain,ytrain,xtest,ytest,nTest,pMean,pVar,figName);
    ...
    % ADMM ML Opt
    options_ADMM = struct('rho', 100, 'rho_dual', 100, 'inner_loop', 300, 'mu', 1e-7, 'MAX_iter', 10000, 'nv', varEst, ...
                          'iniAlpha', alpha_DCP);
