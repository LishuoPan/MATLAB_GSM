...
Nystrom_activate = 1; % 0 for deactivate nystrom, 1 for activate nystrom
...
figName = ['./fig/',file_name,'_',sample_method,'_Q',int2str(Q),'_Nys',num2str(nys_sample),'.fig'];
...
% Save info
save(['./fig/',file_name,'_',sample_method,'_Q',int2str(Q),'_Nys',num2str(nys_sample),'.mat'], 'MSE', 'info','time_record');
